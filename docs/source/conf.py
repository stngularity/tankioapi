...
github = f"https://github.com/{author}/{project}/"
...
extensions = ["sphinxawesome_theme", "sphinx_design", "sphinx.ext.autodoc", "sphinx.ext.napoleon", "myst_parser"]
